...
select r1.src as v1, r1.dst as v2, s1.src as v3, s1.dst as v4, T.src as v5, T.dst as v6 from r1 right outer join s1 on r1.dst = s1.src full outer join T on s1.dst = T.src;