...
SELECT r1.src as v1, r1.dst as v2, s2.src as v3, s2.dst as v4, T.src as v5, T.dst as v6 FROM r1 right outer join s2 on r1.dst = s2.src right outer join T on s2.dst = T.src;