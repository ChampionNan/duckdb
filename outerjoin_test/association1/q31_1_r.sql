...
SELECT r1.src as v1, r1.dst as v2, s1.src as v3, s1.dst as v4, t1.src as v5, t1.dst as v6 FROM r1 RIGHT OUTER JOIN s1 ON r1.dst = s1.src INNER JOIN t1 ON s1.dst = t1.src;