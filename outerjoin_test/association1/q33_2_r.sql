...
SELECT r1.src as v1, r1.dst as v2, s1.src as v3, s1.dst as v4, T.src as v5, T.dst as v6 FROM r1 RIGHT OUTER JOIN (s1 RIGHT OUTER JOIN T ON s1.dst = T.src) ON r1.dst = s1.src;