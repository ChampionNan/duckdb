...
SELECT R.src as v1, R.dst as v2, s1.src as v3, s1.dst as v4, t1.src as v5, t1.dst as v6 FROM R LEFT OUTER JOIN (s1 LEFT OUTER JOIN t1 ON s1.dst = t1.src) ON R.dst = s1.src;